...
public:
  ...
  // sets this quaternion to be a rotation of fRadians about v = < fx, fy, fz >, v need not
  ...
  static Quat4f squad(const Quat4f &a, const Quat4f &tanA, const Quat4f &tanB, const Quat4f &b,
                      float t);

  static Quat4f cubicInterpolate(const Quat4f &q0, const Quat4f &q1, const Quat4f &q2,
